...
```json
{
  ...
  "missingData": {
    ...
    "blogDescription": {
      "count": 96,
      "percentage": 5.9,
      "posts": [{ "title": "...", "link": "...", "author": "...", "slugifiedAuthor": "..." }, ...]
    }
  }
}
```
...
- **`missingData`** has four sections (`rssLink`, `favicon`, `authorDescription`, `blogDescription`), each with `count`, `percentage`, and an `authors` or `posts` array. The `blogDescription.posts` entries include `author` and `slugifiedAuthor` for linking to author pages
