...
**Odds and Ends.** This just in (on Friday, July 28), there's a new starter from [Łukasz Wójcik](/authors/lukasz-wojcik/). It's called [Multiplicity - RSS Aggregator Starter Based On Eleventy](https://github.com/lwojcik/eleventy-template-multiplicity#multiplicity---rss-aggregator-starter-based-on-eleventy). It's based on his [BLOGWORM site](https://blogworm.eu/).
